 ...
 */
public class ProductosFragmentTwo extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String TIPO = "tipoProducto";

    private ProductosFragment.OnFragmentInteractionListener mListener2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista2 = inflater.inflate(R.layout.fragment_productos_fragment_two, container, false);

        productos=new ArrayList<>();

        recyclerProductos = (RecyclerView) vista2.findViewById(R.id.idRecyclerProducto2);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ProductosFragment.OnFragmentInteractionListener) {
            mListener2 = (ProductosFragment.OnFragmentInteractionListener) context;
        } else {
