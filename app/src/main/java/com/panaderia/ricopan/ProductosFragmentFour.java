 ...
 */
public class ProductosFragmentFour extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    private ProductosFragment.OnFragmentInteractionListener mListener4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista4 = inflater.inflate(R.layout.fragment_productos_fragment_four, container, false);

        productos=new ArrayList<>();

        recyclerProductos = (RecyclerView) vista4.findViewById(R.id.idRecyclerProducto4);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener4 != null) {
            mListener4.onFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ProductosFragment.OnFragmentInteractionListener) {
            mListener4 = (ProductosFragment.OnFragmentInteractionListener) context;
        } else {
