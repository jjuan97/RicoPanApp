 ...
 */
public class ProductosFragmentOne extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    private ProductosFragment.OnFragmentInteractionListener mListener1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_productos_fragment_one, container, false);

        productos=new ArrayList<>();

        recyclerProductos = (RecyclerView) vista.findViewById(R.id.idRecyclerProducto1);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ProductosFragment.OnFragmentInteractionListener) {
            mListener1 = (ProductosFragment.OnFragmentInteractionListener) context;
        } else {
